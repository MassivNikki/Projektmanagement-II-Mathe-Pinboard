<div class='post'>
<?php
    $filename = "posts/post-20.xml";
    // Process the form submission
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["type"]) && ($_POST["type"]=="delete" || $_POST["type"]=="upvote20" || $_POST["type"]=="downvote20")) {
        if($_POST["type"]=="delete"){
        $fileToDelete = "./posts/post-20.php";
...
echo "<b> Points: $pointsLoaded </b>";
    ...
    <div  class="deleteBtn">
    <form method="POST">
    <input type="hidden" name="fileToBeDeleted" value="./posts/post-20.php">
    ...
    <div class="upvoteBtn">
    <form method="POST" >
    <input type="hidden" name="type" value="upvote20">
        <button type="submit">Points +1</button>
    </form>
    </div>
    <div class="downvoteBtn">
    <form method="POST" >
    <input type="hidden" name="type" value="downvote20">
        <button type="submit">Points -1</button>
    </form>
    </div>
    <p><strong>dgfdgf</strong></p>
<p class='commentText'>gggg</p>
