<div class='post'>
<?php
    $filename = "posts/post-9.xml";
    // Process the form submission
    if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["type"]) && ($_POST["type"]=="delete" || $_POST["type"]=="upvote9" || $_POST["type"]=="downvote9")) {
        if($_POST["type"]=="delete"){
        $fileToDelete = "./posts/post-9.php";
...
echo "<b> Points: $pointsLoaded </b>";
    ...
    <div  class="deleteBtn">
    <form method="POST">
    <input type="hidden" name="fileToBeDeleted" value="./posts/post-9.php">
    ...
    <div class="upvoteBtn">
    <form method="POST" >
    <input type="hidden" name="type" value="upvote9">
        <button type="submit">Points +1</button>
    </form>
    </div>
    <div class="downvoteBtn">
    <form method="POST" >
    <input type="hidden" name="type" value="downvote9">
        <button type="submit">Points -1</button>
    </form>
    </div>
